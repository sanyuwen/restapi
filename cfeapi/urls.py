...
urlpatterns = [
    ...
    path('json/cbv/', views.JsonCBV.as_view()),
    path('json/cbv2/', views.JsonCBV2.as_view()),
    path('json/example/', views.json_example_view),
    path('json/serializer/list/', views.SerializeListView.as_view()),
    path('json/serializer/detail/', views.SerializeDetailView.as_view()),
]
